...
story1.innerHTML = `
<h3>Історія 1: Змія рятує пташеня</h3>
<p>Змія помітила маленьке пташеня, якого підстерігав яструб. Своїми плавними, хвилеподібними рухами вона лавірувала серед гілок, коригуючи траєкторію, щоб врятувати пташеня в останній момент.</p>
<div class="canvas-container">
<canvas id="snakeCanvas" width="800" height="300" style="border:1px solid #ccc; background:#fff;"></canvas><br>
<iframe src="zmeja.html" width="680" height="400" frameborder="0" marginheight="0" marginwidth="0">Завантаження…</iframe>
</div>
<p class="wish">Спостерігаючи за тим, як змія лавірує серед гілок і рятує пташеня, пам'ятайте: навіть найскладніші траєкторії можна зрозуміти, якщо дивитися уважно і намагатися моделювати рух. Нехай ваша допитливість веде вас, як гнучке тіло змії, до нових відкриттів!</p>`;
/*
